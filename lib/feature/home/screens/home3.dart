...
import 'package:wasel/core/Models/restaurants_model.dart';
import 'package:wasel/core/Theme/app_color.dart';
import 'package:wasel/feature/Home/Widgets/coustm_searchfiled.dart';
                 ...
                 children: List.generate(rest.length, (index){
                   ...
                   return Padding(
                     ...
                     child: Container(
                       ...
                       child: Row(
                         children: [
                           Container(width: 61,height: 58,decoration: BoxDecoration(color: AppColor.mainColor , borderRadius: BorderRadius.circular(12)),),
                           SizedBox(width: 8,),
